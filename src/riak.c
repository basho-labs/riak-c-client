...
riak_get(riak_connection    *cxn,
    ...
    err = riak_get_request_encode(rop, bucket_type, bucket, key, opts, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_delete(riak_connection    *cxn,
    ...
    err = riak_delete_request_encode(rop, bucket_type, bucket, key, opts, &(rop->pb_request));
    if (err) {
        return err;
    }
...
riak_listbuckets(riak_connection            *cxn,
    ...
    err = riak_listbuckets_request_encode(rop, bucket_type, timeout, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_listkeys(riak_connection         *cxn,
    ...
    err = riak_listkeys_request_encode(rop, bucket_type, bucket, timeout, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_get_bucketprops(riak_connection                *cxn,
    ...
    err = riak_get_bucketprops_request_encode(rop, bucket_type_bin, bucket_bin, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_reset_bucketprops(riak_connection                  *cxn,
    ...
    err = riak_reset_bucketprops_request_encode(rop, bucket_type_bin, bucket_bin, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_set_bucketprops(riak_connection                *cxn,
    ...
    err = riak_set_bucketprops_request_encode(rop, bucket_type_bin, bucket_bin, props, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_2i(riak_connection       *cxn,
    ...
    err = riak_2i_request_encode(rop, bucket_type, bucket, index, opts, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
...
riak_search(riak_connection       *cxn,
    ...
    err = riak_search_request_encode(rop, bucket_bin, query, opts, &(rop->pb_request));
    if (err) {
        return err;
    }
    err = riak_sync_request(&rop, (void**)response);
